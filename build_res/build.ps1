...
function release() {
    ...
    npx sass ./src/:./build/
    Write-Output "[ 50%] Autoprefix CSS"
    npx postcss ./build/minimal.css --use autoprefixer -o ./build/minimal.prefixed.css
    Remove-Item ./build/minimal.css
    Move-Item ./build/minimal.prefixed.css -Destination ./build/minimal.css
    ...
    Write-Output "/* minimal.css v0.8.0 CSS component for production | AGPLv3 | github.com/HereIsKevin/minimal.css */" > ./out/minimal.min.css
    Get-Content ./build/minimal.min.css >> ./out/minimal.min.css
    Write-Output "/* minimal.css v0.8.0 JS component for production | AGPLv3 | github.com/HereIsKevin/minimal.css */" > ./out/minimal.min.js
    Get-Content ./build/minimal.min.js >> ./out/minimal.min.js
    Write-Output "/* minimal.css v0.8.0 CSS component for tests | AGPLv3 | github.com/HereIsKevin/minimal.css */" > ./out/minimal.css
    Get-Content ./build/minimal.css >> ./out/minimal.css
    Write-Output "/* minimal.css v0.8.0 JS component for tests | AGPLv3 | github.com/HereIsKevin/minimal.css */" > ./out/minimal.js
